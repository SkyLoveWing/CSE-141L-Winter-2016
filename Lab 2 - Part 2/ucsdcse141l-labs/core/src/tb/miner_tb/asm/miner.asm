...
.const %IV_BASE, IV
.const %K_BASE, K
//.const %XOR, XOR  - Commented out, due to being defined already
//.const %ROR, ROR  - Commented out, due to being defined already
.const %SMSIG0, SMSIG0
.const %SMSIG1, SMSIG1
...
// $R8 : rotate amount
// $R9 : return value
//ROR: Commented out, due to being defined already
//    MOV  $R9, $R7
//    MOV  $R10, %S32
//    SUBU $R10, $R8
//    SRLV $R7, $R8
...
// $R8 : B
// $R9 : return value
//XOR: Commented out, due to being defined already
//    MOV $R9, $R7
//    MOV $R10, $R8
//    NOR $R9, $R9 // ~A
//    NOR $R10, $R10 // ~B
